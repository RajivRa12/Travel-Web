...
"[project]/src/components/filter-sheet.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const FilterSheet = ({ onApplyFilters })=>{
    _s();
    const [destination, setDestination] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("All");
    ...
    const [duration, setDuration] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("any");
    const [rating, setRating] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(1);
    const handleApply = ()=>{
        if (onApplyFilters) {
            onApplyFilters({
                destination,
...
_s(FilterSheet, "7hs4AReLezMFsEozvJg13oVTf5I=");
_c = FilterSheet;
var _c;
...
"[project]/src/app/packages/AllPackagesClient.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$filter$2d$sheet$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/filter-sheet.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/data.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
...
;
;
const PackagesHeader = ()=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("header", {
...
function AllPackagesClient() {
    ...
    const [packageList, setPackageList] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["packages"]);
    ...
    const applyFilters = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AllPackagesClient.useCallback[applyFilters]": (newFilters, searchTerm)=>{
            if (newFilters) {
                setFilters(newFilters);
            }
            const currentFilters = newFilters || filters;
            const currentSearch = searchTerm !== undefined ? searchTerm : searchQuery;
            let filtered = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["packages"];
            // Apply search filter first
            if (currentSearch && currentSearch.trim()) {
                const normalizedQuery = currentSearch.toLowerCase().trim();
                filtered = filtered.filter({
                    "AllPackagesClient.useCallback[applyFilters]": (pkg)=>{
                ...
                }["AllPackagesClient.useCallback[applyFilters]"]);
            }
            // Apply destination filter
            if (currentFilters.destination !== "All") {
                filtered = filtered.filter({
                    "AllPackagesClient.useCallback[applyFilters]": (p)=>p.destination === currentFilters.destination
                }["AllPackagesClient.useCallback[applyFilters]"]);
            }
            // Apply budget filter
            filtered = filtered.filter({
                "AllPackagesClient.useCallback[applyFilters]": (p)=>parseInt(p.price.replace(/,/g, "")) <= currentFilters.budget
            }["AllPackagesClient.useCallback[applyFilters]"]);
            ...
            if (currentFilters.duration !== "any") {
                ...
                if (durationValue === "7+") {
                    filtered = filtered.filter({
                        "AllPackagesClient.useCallback[applyFilters]": (p)=>parseInt(p.duration) >= 7
                    }["AllPackagesClient.useCallback[applyFilters]"]);
                } else {
                    const [min, max] = durationValue.split("-").map(Number);
                    filtered = filtered.filter({
                        "AllPackagesClient.useCallback[applyFilters]": (p)=>{
            ...
            // Apply rating filter
            filtered = filtered.filter({
                "AllPackagesClient.useCallback[applyFilters]": (p)=>p.rating >= currentFilters.rating
            }["AllPackagesClient.useCallback[applyFilters]"]);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(PackagesHeader, {}, void 0, false, {
                        fileName: "[project]/src/app/packages/AllPackagesClient.tsx",
                        lineNumber: 135,
                        columnNumber: 11
                    }, this),
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$filter$2d$sheet$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FilterSheet"], {
...
_s(AllPackagesClient, "FBsBSv9eMEHqLNadRveLC7m2Zbs=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSearchParams"]
    ];
});
_c1 = AllPackagesClient;
var _c, _c1;
__turbopack_context__.k.register(_c, "PackagesHeader");
__turbopack_context__.k.register(_c1, "AllPackagesClient");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_dce6a1c0._.js.map