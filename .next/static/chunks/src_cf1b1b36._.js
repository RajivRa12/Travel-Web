...
"[project]/src/components/auth/auth-context.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/components/context/cart-context.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/components/context/wishlist-context.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const WishlistProvider = ({ children })=>{
    ...
    const getWishlistPackages = ()=>{
        return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["packages"].filter((pkg)=>wishlistItems.includes(pkg.id));
    };
    const clearWishlist = ()=>{
        setWishlistItems([]);
    };
...
_s(WishlistProvider, "ay+O0wjMrdcSNBGWoflI0RnjztE=", false, function() {
    return [
...
//# sourceMappingURL=src_cf1b1b36._.js.map